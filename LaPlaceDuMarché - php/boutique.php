...
<?php
    ...
    while($s=$select->fetch(PDO::FETCH_OBJ)){
        ...
        <div class="col-md-6 col-lg-3 ftco-animate">
			<div class="product">
				<a href="#" class="img-prod"><img src="admin/images/<?php echo $s->title; ?>.jpg" alt="Colorlib Template"/>
				...
				<div class="text py-3 pb-4 px-3 text-center">
					...
					<div class="d-flex">
						<div class="pricing">
							<p class="price"><span class="mr-2 price-dc"><?php echo $s->price; ?> €</span>
                            <spanclass="price-sale">$80.00</spanclass=></p>
						</div>
					</div>
